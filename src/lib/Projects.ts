...
const projects: Project[] = [
  {
    imageSrc: "../assets/projects/drone.png",
    title: "Rust-based Flight Controller",
    tag: ["Rust", "STM32", "Embedded", "RTOS"],
    ...
    blogLink: "https://blog.kaving.me/blog/rust-based-flight-controller/"
  },
  {
    imageSrc: "../assets/projects/motor_controller.gif",
  ...
  {
    imageSrc: "../assets/projects/nes.png",
    title: "NES Emulator",
    tag: ["C", "Emulation", "CPU", "SDL2", "DSP"],
    ...
    githubLink: "https://github.com/KavinTheG/NES",
    blogLink: "https://blog.kaving.me/blog/nes-emulator/",
  },
  {
    imageSrc: "../assets/projects/chip8.png",
  ...
  {
    imageSrc: "../assets/projects/pychess.png",
    title: "PyChess",
    tag: ["Python", "PyGame", "DSA"],
